...
var stream_adder_content = new Map([
   ['en', 'ADD STREAM: <input type=text id=lsender_stream value="https://masterpl.hls.nhkworld.jp/hls/w/live/master.m3u8" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {mod8.close();gifrid=this.value;gifr(this.value)} else {this.placeholder = \'???\';}}">'],
   ['ru', 'ADD STREAM: <input type=text id=lsender_stream value="https://masterpl.hls.nhkworld.jp/hls/w/live/master.m3u8" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {mod8.close();gifrid=this.value;gifr(this.value)} else {this.placeholder = \'???\';}}">'],
   ['es', 'ADD STREAM: <input type=text id=lsender_stream value="https://masterpl.hls.nhkworld.jp/hls/w/live/master.m3u8" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {mod8.close();gifrid=this.value;gifr(this.value)} else {this.placeholder = \'???\';}}">'],
   ['fr', 'ADD STREAM: <input type=text id=lsender_stream value="https://masterpl.hls.nhkworld.jp/hls/w/live/master.m3u8" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {mod8.close();gifrid=this.value;gifr(this.value)} else {this.placeholder = \'???\';}}">'],
   ['cn', 'ADD STREAM: <input type=text id=lsender_stream value="https://masterpl.hls.nhkworld.jp/hls/w/live/master.m3u8" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {mod8.close();gifrid=this.value;gifr(this.value)} else {this.placeholder = \'???\';}}">'],
   ['pt', 'ADD STREAM: <input type=text id=lsender_stream value="https://masterpl.hls.nhkworld.jp/hls/w/live/master.m3u8" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {mod8.close();gifrid=this.value;gifr(this.value)} else {this.placeholder = \'???\';}}">'],
]);
